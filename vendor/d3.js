!(function () {
  ...
  function lo(n, t) {
    return n.length < 3
      ? uo(n)
      : n[0] + ho((n.push(n[0]), n), go([n[n.length - 2]].concat(n, [n[1]]), t))
  }
  function fo(n, t) {
        ...
        return function () {
          function a() {
            ...
            r &&
              ...
              (p |= n | e),
              (x = r),
              g({ type: 'drag', x: r[0] + s[0], y: r[1] + s[1], dx: n, dy: e }))
          }
          function c() {
            t(h, v) &&
        ...
        if (r && r.length) {
          ...
          for (n(a, (o.dx * o.dy) / t.value), c.area = 0; (i = a.pop()); )
            c.push(i),
              (c.area += i.area),
              null != i.z &&
                (u(c, i.z ? o.dx : o.dy, o, !a.length), (c.length = c.area = 0))
          r.forEach(e)
        }
      }
      function r(n, t) {
